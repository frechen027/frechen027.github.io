...
👋 你好！我是本站的主理人。这是一个记录我的学习笔记、技术沉淀与日常心得的数字花园，内容主要涵盖 Python 编程、大语言模型算法、数据科学以及校招面经。
...
!!! info "Current Focus"
当前主要研究与学习的方向为 **LLM 后训练 (Post-Training)** 与 **AI Agent** 的开发与应用。
包括 SFT、RLHF、Huggingface TRL 框架实践以及智能体开发等。
...
> 探索最前沿的 AI 技术，从底层原理到落地实战。
>
> - [🤖 Agent 技术入门](agent/01_Hello-Agents.md) | [🔥 LLM 后训练实践](post_training/01_后训练概述.md) | [💬 软微自然语言处理 (NLP)](nlp/01_自然语言处理.md) | [🦾 强化学习](rl/01_动手学强化学习.md)

💻 **Python 编程修炼**

> 扎实的工程能力是算法落地的基石。
>
> - [🐍 Python 预备知识](basic/01_Python程序基本结构.md) | [🚀 Python 进阶修炼](advanced/01_推导式.md) | [🛠️ 效率工具使用](tools/01_Git与版本控制.md)

📊 **机器学习 & 深度学习**

> 夯实理论基础，紧跟实战框架。
>
> - [📘 动手学深度学习 (李沐)](limu_course/01_动手学深度学习.md) | [🎥 吴恩达机器学习](wu_course/00_AI问答.md) | [📈 数据科学全生命周期](data_science/01_生命周期.md)

⚔️ **算法实战 & 面试指南**

> 备战校招/实习，直通大厂。
>
> - [💡 算法基础与进阶](algo/01_算法概述.md) | [🔥 LeetCode Hot100实战](leetcode/01_Hot100.md) | [💼 算法岗面经流水账](interview/面经流水账.md) | [📚 经典八股与高分经验贴](references/01.md)

---

## 🚀 快速开始

- 🎯 **准备实习/秋招？** 直达 [面经及公司汇总](interview/面经流水账.md) 看面经。
- 📝 **入门 Python？** 请查阅 [Python 程序基本结构](basic/01_Python程序基本结构.md)。
- 🛠️ **想提升工作效率？** 推荐了解 [Vibe Coding](tools/03_Vibe_Coding.md) 和自动化工作流平台 [n8n](tools/06_n8n.md)。

---

## 📮 关于我

欢迎通过阅读侧边栏的具体章节与我交流探讨！如果您也是 AI / 算法方向的同行者，或者在秋招/实习找工作中，希望这里的资料能给您带来帮助！
